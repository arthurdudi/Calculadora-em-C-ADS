...
int main(void) { /* Função principal */
  ...
  printf("Olá, boas vindas! \n \n"); /* \n serve para criar espaço entre linhas! */
  printf("Essa é UMA CALCULADORA NA LINGUAGEM DE PROGRAMAÇÃO C! \n \n");
  printf("Esse projeto foi desenvolvido por Arthur da Rosa Pacheco, estudante de ADS na Universidade La Salle. \n \n");
  printf("O trabalho é para a disciplina de Algoritmos e Programação. \n \n");
  printf("Vamos começar? \n \n");
  printf("***CALCULADORA EM C*** \n \n");
  do { /*ESTRUTURA DE REPETIÇÃO PARA CRIAR O LOOP */
    int operacaoInvalida = 0; /*VARIÁVEL PARA OPERAÇÃO INVÁLIDA */
    printf("\n***Escolha a operação desejada!*** \n \n");
    printf("SOMA = 1 \nSUBTRAÇÃO = 2 \nMULTIPLICAÇÃO = 3 \nDIVISÃO = 4 "
           "\nPOTÊNCIA = 5 \nRAIZ QUADRADA = 6\n");
    scanf("%d", &menu); /* Essa vírgula me deu alguns problemas. Esqueci de botar e quase ferrei o código. SEMPRE LEMBRAR! */
    switch (menu) {
    case 1:
      printf("\nVocê escolheu SOMA! ");
      printf("\nDigite o primeiro número: "); /* Sempre incluir espaço após os dois pontos para que o prompt fique mais limpo */
      scanf("%f", &n1); 
      printf("\nDigite o segundo número: ");
      scanf("%f", &n2);
      resultado = n1 + n2;
      printf("\nO RESULTADO É %.2f \n",resultado); /* A ordem dos números após a vírgula é a ordem que eles aparecerão na operação. O 2f é para limitar o número de casas decimais após a vírgula, limitando a apenas 2. Se fosse 1, seria 1f e assim por diante. */
      break;
    case 2:
